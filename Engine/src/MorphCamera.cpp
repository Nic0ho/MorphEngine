...
namespace Morph
{
Camera::Camera(glm::vec3 position, float fov, float aspect, float nearPlane, float farPlane): m_position(position), m_fov(fov), m_aspect(aspect), m_near(nearPlane), m_far(farPlane)
{ UpdateVectors(); }
