...
GraphicsPipeline::~GraphicsPipeline()
{
    ...
    if (m_descriptorSetLayout != VK_NULL_HANDLE) vkDestroyDescriptorSetLayout(m_device, m_descriptorSetLayout, NULL);
    if (m_descriptorPool != VK_NULL_HANDLE) vkDestroyDescriptorPool(m_device, m_descriptorPool, NULL);
}
...
void GraphicsPipeline::CreateDescriptorSetLayout(std::vector<BufferAndMemory>& UniformBuffers, int UniformDataSize, VulkanTexture* pTex)
{
    ...
    if (pTex) LayoutBindings.push_back(FragmentShaderLayoutBinding);
